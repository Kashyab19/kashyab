    ...
    <footer className="site-footer">
      <nav className="footer-nav" aria-label="footer links">
        ...
        <div className="footer-text-links">
          ...
          <Link to="/claurden" className="footer-link">AI Garden</Link>
        </div>
        {/* Mobile: icons + AI Garden text */}
        <div className="footer-social-icons">
          {navLinks.map((link) => (
            ...
            >
              {footerIcons[link.label.toLowerCase()]}
            </a>
          ))}
          <Link to="/claurden" className="icon-link" aria-label="AI Garden">
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <main className="app-container">
      <div className="profile-header">
        <div className="profile-pic-wrap">
          <img className="profile-pic" src={profileImage} alt={`${personalInfo.name} profile`} width="95" height="95" />
        </div>
